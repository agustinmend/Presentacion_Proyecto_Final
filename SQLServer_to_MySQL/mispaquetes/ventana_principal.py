...
import mispaquetes.pruebas as pruebas
...
def iniciar_programa():
    ...
    try:
        ...
        boton_pruebas = tk.Button(root , text='PRUEBAS' , command= lambda : pruebas.prueba(conn_sqlserver , conn_mysql))
        boton_pruebas.pack(pady=20)
